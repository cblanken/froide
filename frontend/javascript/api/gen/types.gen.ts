...
export const BlankEnum = { '': '' } as const
...
export type FoiRequestDetail = {
  ...
  readonly status_representation: string
  readonly readable_status: string
  ...
  readonly project_site_url: string
  readonly project_request_count: string
...
export type Jurisdiction = {
  ...
  readonly region_kind_detail: string
  readonly last_modified_at: Date
}
 ...
 * * `admin_court_jurisdiction` - administrative court jurisdiction
 */
export type KindDd3Enum = (typeof KindDd3Enum)[keyof typeof KindDd3Enum]
...
export type PaginatedDocumentPortalList = {
  count: number
  next?: string | null
  previous?: string | null
  results: Array<DocumentPortal>
}
...
export type PublicBody = {
  ...
  readonly alternative_emails: string
...
export type DocumentPortalWritable = {
  title: string
  description?: string
}
...
export type PaginatedDocumentPortalListWritable = {
  count: number
  next?: string | null
  previous?: string | null
  results: Array<DocumentPortalWritable>
}
...
export type DocumentportalListData = {
  body?: never
  path?: never
  query?: {
    format?: 'csv' | 'json'
...
export type DocumentportalListResponses = {
  200: PaginatedDocumentPortalList
}

export type DocumentportalListResponse =
  DocumentportalListResponses[keyof DocumentportalListResponses]

export type DocumentportalRetrieveData = {
  body?: never
  path: {
    /**
     * A unique integer value identifying this document portal.
     */
    id: number
  }
  query?: {
...
export type DocumentportalRetrieveResponses = {
  200: DocumentPortal
}

export type DocumentportalRetrieveResponse =
  DocumentportalRetrieveResponses[keyof DocumentportalRetrieveResponses]

export type DocumentportalOembedRetrieveData = {
  body?: never
  path?: never
  query?: {
    format?: 'csv' | 'json'
...
export type DocumentportalOembedRetrieveResponses = {
  200: DocumentPortal
}

export type DocumentportalOembedRetrieveResponse =
  DocumentportalOembedRetrieveResponses[keyof DocumentportalOembedRetrieveResponses]
