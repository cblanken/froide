...
import type {
  ...
  DocumentportalListResponse,
  DocumentportalOembedRetrieveResponse,
  DocumentportalRetrieveResponse,
...
const paginatedFoiAttachmentListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    foiAttachmentSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedCampaignListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    campaignSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedDocumentListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    documentSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedDocumentCollectionListSchemaResponseTransformer = (
  ...
  data.results = data.results.map((item: any) =>
    documentCollectionSchemaResponseTransformer(item)
  )
  return data
}
...
const documentPortalSchemaResponseTransformer = (data: any) => {
  data.created_at = new Date(data.created_at)
  return data
}

const paginatedDocumentPortalListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    documentPortalSchemaResponseTransformer(item)
  )
  return data
}

export const documentportalListResponseTransformer = async (
  data: any
): Promise<DocumentportalListResponse> => {
  data = paginatedDocumentPortalListSchemaResponseTransformer(data)
  return data
}

export const documentportalRetrieveResponseTransformer = async (
  data: any
): Promise<DocumentportalRetrieveResponse> => {
  data = documentPortalSchemaResponseTransformer(data)
  return data
}

export const documentportalOembedRetrieveResponseTransformer = async (
  data: any
): Promise<DocumentportalOembedRetrieveResponse> => {
  data = documentPortalSchemaResponseTransformer(data)
  return data
}
...
const paginatedFoiRequestFollowListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    foiRequestFollowSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedGeoRegionListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    geoRegionSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedJurisdictionListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    jurisdictionSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedFoiLawListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    foiLawSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedFoiMessageListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    foiMessageSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedPageAnnotationListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    pageAnnotationSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedProblemReportListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    problemReportSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedPublicBodyListListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    publicBodyListSchemaResponseTransformer(item)
  )
  return data
}
...
const paginatedFoiRequestListListSchemaResponseTransformer = (data: any) => {
  data.results = data.results.map((item: any) =>
    foiRequestListSchemaResponseTransformer(item)
  )
  return data
}
