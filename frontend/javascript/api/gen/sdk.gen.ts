...
import type {
  ...
  DocumentportalListData,
  DocumentportalListResponses,
  DocumentportalOembedRetrieveData,
  DocumentportalOembedRetrieveResponses,
  DocumentportalRetrieveData,
  DocumentportalRetrieveResponses,
...
export const campaignList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<CampaignListResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
...
export const categoryList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<CategoryListResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
...
export const documentList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<DocumentListResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
...
export const documentportalList = <ThrowOnError extends boolean = false>(
  options?: Options<DocumentportalListData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    DocumentportalListResponses,
    unknown,
  ...
  >({
    ...
    url: '/api/v1/documentportal/',
    ...options
  })

export const documentportalRetrieve = <ThrowOnError extends boolean = false>(
  options: Options<DocumentportalRetrieveData, ThrowOnError>
) =>
  (options.client ?? client).get<
    DocumentportalRetrieveResponses,
    unknown,
  ...
  >({
    ...
    url: '/api/v1/documentportal/{id}/',
    ...options
  })

export const documentportalOembedRetrieve = <
  ThrowOnError extends boolean = false
>(
  options?: Options<DocumentportalOembedRetrieveData, ThrowOnError>
) =>
  (options?.client ?? client).get<
    DocumentportalOembedRetrieveResponses,
    unknown,
  ...
  >({
    ...
    url: '/api/v1/documentportal/oembed/',
    ...options
  })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/georegion/reconciliation/', ...options })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/georegion/reconciliation-flyout/', ...options })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/georegion/reconciliation-propose-properties/', ...options })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/georegion/reconciliation-suggest-service/', ...options })
...
export const lawList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<LawListResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
export const lawRetrieve = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).get<LawRetrieveResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
export const messageList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<MessageListResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
export const messageUpdate = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).put<MessageUpdateResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
...
export const pageList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<PageListResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/publicbody/reconciliation/', ...options })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/publicbody/reconciliation-flyout/', ...options })
...
>(
  ...
  (options?.client ?? client).get<
    ...
    unknown,
    ThrowOnError
  >({ url: '/api/v1/publicbody/reconciliation-suggest-service/', ...options })
...
export const requestList = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<RequestListResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
export const requestUpdate = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).put<RequestUpdateResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
...
export const uploadUpdate = <ThrowOnError extends boolean = false>(
  ...
  (options.client ?? client).put<UploadUpdateResponses, unknown, ThrowOnError>({
    security: [
      {
        in: 'cookie',
        name: 'sessionid',
...
export const userRetrieve = <ThrowOnError extends boolean = false>(
  ...
  (options?.client ?? client).get<UserRetrieveResponses, unknown, ThrowOnError>(
    {
      security: [
        {
          in: 'cookie',
